    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_expired', models.DateField(default=datetime.date(2019, 11, 19), verbose_name='Ημερομηνία')),
                ...
                ('subscribe_cost', models.DecimalField(decimal_places=2, default=0, max_digits=20)),
                ('subscribe_discount_cost', models.DecimalField(decimal_places=2, default=0, max_digits=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_related', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='point_of_sale.Order')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ManyToManyField(null=True, to='catalogue.Attribute')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gifts', to='point_of_sale.Order')),
                ('order_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='point_of_sale.OrderItem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_related', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_subscribes', to='point_of_sale.Order')),
