...
from .views import (CartListView, CartUpdateView, check_cart_movement, ajax_cart_change_qty,
                    create_order_from_cart_view, clear_cart_view
                    )
...
urlpatterns = [
    ...
    path('clear/carts/', clear_cart_view, name='clear_cart_view'),
